...
export function straightMovement(): BulletMovement {
...
export function acceleratedMovement(slowness: number): BulletMovement {
	return (bullet, time, p) => {
...
// Creates a straight movement parametric function
export function shapeMovement(rotation: number): BulletMovement {
	return (bullet, time, p) => {
...
export function playerBulletMovement(offset: number): BulletMovement {
	return (bullet, time, p) => {
