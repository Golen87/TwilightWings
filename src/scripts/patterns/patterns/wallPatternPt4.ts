...
// WARNING: SUPER HARD PHASE DO NOT USE UNLESS YOU WANT TO HAVE A BAD TIME
const wallPattern4: Pattern[][] = [
	[
	...
	[
		{type: false, radius: 5, speed: 140, amount: 24, offset: 0, degrees: 345, x: 0, y: -0.5, varx: 0.2, vary: 0.15, angle: 90, wait: 0},
		{type: true, radius: 5, speed: 140, amount: 24, offset: 7.5, degrees: 345, x: 0, y: -0.5, varx: 0.2, vary: 0.15, angle: 90, wait: 1},
		{type: false, radius: 5, speed: 140, amount: 24, offset: 7.5, degrees: 345, x: 0, y: -0.5, varx: 0.2, vary: 0.15, angle: 90, wait: 0},
		{type: true, radius: 5, speed: 140, amount: 24, offset: 0, degrees: 345, x: 0, y: -0.5, varx: 0.2, vary: 0.15, angle: 90, wait: 1},
	]
];

export default wallPattern4;
