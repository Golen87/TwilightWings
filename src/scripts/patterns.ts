...
// 	{type: true, radius:  6, speed: 300, amount:   1, offset: 0, degrees:  10*1, wait: 0.2}, // Alternating Speeds
// 	{type: false, radius:  6, speed: 200, amount:   2, offset: 0, degrees:  10*2, wait: 0.2},
// 	{type: true, radius:  6, speed: 300, amount:   3, offset: 0, degrees:  10*3, wait: 0.2},
// 	{type: false, radius:  6, speed: 200, amount:   1, offset: 0, degrees:  10*1, wait: 0.2},
// 	{type: true, radius:  6, speed: 300, amount:   2, offset: 0, degrees:  10*2, wait: 0.2}, 
// 	{type: false, radius:  6, speed: 200, amount:   3, offset: 0, degrees:  10*3, wait: 0.2},
// ];
...
let arrow = [[
	{type: true, radius: 4, speed: [150,140,130,120,110], amount: [1, 2, 2, 2, 2], offset: 0, degrees: [0,5,10,15,20], wait: 1},
]];

let spiral = [[
	{type: true, radius:  4, speed: 110, amount:   36, offset: 0, degrees:  360, wait: 0.15, angle: 0},
	{type: true, radius:  4, speed: 110, amount:   36, offset: 2, degrees:  360, wait: 0.15, angle: 0},
	{type: true, radius:  4, speed: 110, amount:   36, offset: 4, degrees:  360, wait: 0.15, angle: 0},
	{type: true, radius:  4, speed: 110, amount:   36, offset: 6, degrees:  360, wait: 0.15, angle: 0},
	{type: true, radius:  4, speed: 110, amount:   36, offset: 8, degrees:  360, wait: 0.15, angle: 0},
]];

let laser = [[
	{type: true, radius: [2,3,4,5,4,3,2], speed: [135,140,145,150,155,160,165], amount: [3, 3, 3, 3, 3, 3, 3], offset: 0, degrees: 30, wait: 1}
]];

let fourWay = [[
	{type: true, radius: [16,14,14,12,12,10,10], speed: 120, amount: [5, 5, 5, 5, 5, 5, 5], offset: [45, 40, 50, 35, 55, 30, 60], degrees: 360, wait: 1},
]];
...
let zigzag = [[
	{type: true, radius: 4, speed: 120, amount: 1, offset: -30, degrees: 0, wait: 0.05},
	{type: true, radius: 4, speed: 120, amount: 1, offset: -20, degrees: 0, wait: 0.05},
	{type: true, radius: 4, speed: 120, amount: 1, offset: -10, degrees: 0, wait: 0.05},
	{type: true, radius: 4, speed: 120, amount: 1, offset: 0, degrees: 0, wait: 0.05},
	{type: true, radius: 4, speed: 120, amount: 1, offset: 10, degrees: 0, wait: 0.05},
	{type: true, radius: 4, speed: 120, amount: 1, offset: 20, degrees: 0, wait: 0.05},
	{type: true, radius: 4, speed: 120, amount: 1, offset: 30, degrees: 0, wait: 0.05},
	{type: true, radius: 4, speed: 120, amount: 1, offset: 20, degrees: 0, wait: 0.05},
...
let hardArcs = [[
	{type: true, radius: 6, speed: [140, 130, 120, 110, 100, 90], amount: 1, offset: [10, 0, -10, -20, -30, -40], degrees: 0, wait: 0.25},
	{type: true, radius: 6, speed: [140, 130, 120, 110, 100, 90], amount: 1, offset: [-10, 0, 10, 20, 30, 40], degrees: 0, wait: 0.5},
	{type: true, radius: 6, speed: [180, 170, 160, 150, 140, 130], amount: 1, offset: [15, 5, -5, -15, -25, -35], degrees: 0, wait: 0.25},
	{type: true, radius: 6, speed: [180, 170, 160, 150, 140, 130], amount: 1, offset: [-15, -5, 5, 15, 25, 35], degrees: 0, wait: 0.5},
]];

let circles = [[
	{type: true, radius: 4, speed: 120, amount: 36, offset: 0, degrees: 350, angle: 90, wait: 0.75},
	{type: true, radius: 4, speed: 120, amount: 36, offset: 5, degrees: 350, angle: 90, wait: 0.75},
]];

let boss = [
	[
		{type: "enemy-night", radius: 10, speed: 120, amount: 24, offset: 0, degrees: 345, angle: 90, wait: 3},
		{type: "enemy-night", radius: 6, speed: [160, 150, 140, 130, 120], amount: [1, 2, 3, 4, 5], offset: 0, degrees: [0, 2, 6, 10, 14], wait: 0.1},
		{type: "enemy-night", radius: 6, speed: [160, 150, 140, 130, 120], amount: [1, 2, 3, 4, 5], offset: 10, degrees: [0, 2, 6, 10, 14], wait: 0},
		{type: "enemy-night", radius: 6, speed: [160, 150, 140, 130, 120], amount: [1, 2, 3, 4, 5], offset: -10, degrees: [0, 2, 6, 10, 14], wait: 0.1},
		{type: "enemy-night", radius: 6, speed: [160, 150, 140, 130, 120], amount: [1, 2, 3, 4, 5], offset: 35, degrees: [0, 2, 6, 10, 14], wait: 0},
		{type: "enemy-night", radius: 6, speed: [160, 150, 140, 130, 120], amount: [1, 2, 3, 4, 5], offset: -35, degrees: [0, 2, 6, 10, 14], wait: 0.1},
		{type: "enemy-night", radius: 6, speed: [160, 150, 140, 130, 120], amount: [1, 2, 3, 4, 5], offset: 65, degrees: [0, 2, 6, 10, 14], wait: 0},
		{type: "enemy-night", radius: 6, speed: [160, 150, 140, 130, 120], amount: [1, 2, 3, 4, 5], offset: -65, degrees: [0, 2, 6, 10, 14], wait: 0.1},
		{type: "enemy-night", radius: 6, speed: [160, 150, 140, 130, 120], amount: [1, 2, 3, 4, 5], offset: 105, degrees: [0, 2, 6, 10, 14], wait: 0},
		{type: "enemy-night", radius: 6, speed: [160, 150, 140, 130, 120], amount: [1, 2, 3, 4, 5], offset: -105, degrees: [0, 2, 6, 10, 14], wait: 1},
		{type: "enemy-night", radius: 10, speed: 120, amount: 24, offset: 0, degrees: 345, angle: 90, wait: 0.5},
		{type: "enemy-night", radius: 6, speed: [180, 170, 160, 150, 140], amount: [1, 2, 3, 4, 5], offset: 0, degrees: [0, 2, 6, 10, 14], wait: 0.1},
		{type: "enemy-night", radius: 6, speed: [180, 170, 160, 150, 140], amount: [1, 2, 3, 4, 5], offset: 10, degrees: [0, 2, 6, 10, 14], wait: 0},
		{type: "enemy-night", radius: 6, speed: [180, 170, 160, 150, 140], amount: [1, 2, 3, 4, 5], offset: -10, degrees: [0, 2, 6, 10, 14], wait: 0.4},
		{type: "enemy-night", radius: 6, speed: [180, 170, 160, 150, 140], amount: [1, 2, 3, 4, 5], offset: 0, degrees: [0, 2, 6, 10, 14], wait: 0.1},
		{type: "enemy-night", radius: 6, speed: [180, 170, 160, 150, 140], amount: [1, 2, 3, 4, 5], offset: 10, degrees: [0, 2, 6, 10, 14], wait: 0},
		{type: "enemy-night", radius: 6, speed: [180, 170, 160, 150, 140], amount: [1, 2, 3, 4, 5], offset: -10, degrees: [0, 2, 6, 10, 14], wait: 0.4},
		{type: "enemy-night", radius: 6, speed: [180, 170, 160, 150, 140], amount: [1, 2, 3, 4, 5], offset: 0, degrees: [0, 2, 6, 10, 14], wait: 0.1},
		{type: "enemy-night", radius: 6, speed: [180, 170, 160, 150, 140], amount: [1, 2, 3, 4, 5], offset: 10, degrees: [0, 2, 6, 10, 14], wait: 0},
		{type: "enemy-night", radius: 6, speed: [180, 170, 160, 150, 140], amount: [1, 2, 3, 4, 5], offset: -10, degrees: [0, 2, 6, 10, 14], wait: 0.4},
		{type: "enemy-night", radius: 6, speed: [180, 170, 160, 150, 140], amount: [1, 2, 3, 4, 5], offset: -105, degrees: [0, 2, 6, 10, 14], wait: 1},
	],
	[
		{type: "enemy-night", radius: 4, speed: 120, amount: 36, offset: 0, degrees: 350, angle: 90, wait: 0.75},
		{type: "enemy-night", radius: 4, speed: 120, amount: 36, offset: 5, degrees: 350, angle: 90, wait: 0.75},
	]
];

let mook = [
	[
		{type: "enemy-night", radius: 6, speed: [140, 130, 120, 110, 100, 90], amount: 1, offset: [10, 0, -10, -20, -30, -40], degrees: 0, wait: 0.5},
		{type: "enemy-night", radius: 6, speed: [140, 130, 120, 110, 100, 90], amount: 1, offset: [-10, 0, 10, 20, 30, 40], degrees: 0, wait: 0.5},
		{type: "enemy-night", radius: 6, speed: [140, 130, 120, 110, 100, 90], amount: 1, offset: [10, 0, -10, -20, -30, -40], degrees: 0, wait: 0.5},
		{type: "enemy-night", radius: 6, speed: [140, 130, 120, 110, 100, 90], amount: 1, offset: [-10, 0, 10, 20, 30, 40], degrees: 0, wait: 2.5},
	],
];

let misc = [
	[
		{type: "enemy-night", radius: [2,3,4,5,4,3,2], speed: [135,140,145,150,155,160,165], amount: [3, 3, 3, 3, 3, 3, 3], offset: 0, degrees: 30, wait: 0.2},
		{type: "enemy-night", radius: [2,3,4,5,4,3,2], speed: [135,140,145,150,155,160,165], amount: [3, 3, 3, 3, 3, 3, 3], offset: -20, degrees: 30, wait: 0},
		{type: "enemy-night", radius: [2,3,4,5,4,3,2], speed: [135,140,145,150,155,160,165], amount: [3, 3, 3, 3, 3, 3, 3], offset: 20, degrees: 30, wait: 0.2},
		{type: "enemy-night", radius: [2,3,4,5,4,3,2], speed: [135,140,145,150,155,160,165], amount: [3, 3, 3, 3, 3, 3, 3], offset: -40, degrees: 30, wait: 0},
		{type: "enemy-night", radius: [2,3,4,5,4,3,2], speed: [135,140,145,150,155,160,165], amount: [3, 3, 3, 3, 3, 3, 3], offset: 40, degrees: 30, wait: 0.2},
		{type: "enemy-night", radius: [2,3,4,5,4,3,2], speed: [135,140,145,150,155,160,165], amount: [3, 3, 3, 3, 3, 3, 3], offset: -60, degrees: 30, wait: 0},
		{type: "enemy-night", radius: [2,3,4,5,4,3,2], speed: [135,140,145,150,155,160,165], amount: [3, 3, 3, 3, 3, 3, 3], offset: 60, degrees: 30, wait: 0.2},
		{type: "enemy-night", radius: [2,3,4,5,4,3,2], speed: [135,140,145,150,155,160,165], amount: [3, 3, 3, 3, 3, 3, 3], offset: -40, degrees: 30, wait: 0},
		{type: "enemy-night", radius: [2,3,4,5,4,3,2], speed: [135,140,145,150,155,160,165], amount: [3, 3, 3, 3, 3, 3, 3], offset: 40, degrees: 30, wait: 0.2},
		{type: "enemy-night", radius: [2,3,4,5,4,3,2], speed: [135,140,145,150,155,160,165], amount: [3, 3, 3, 3, 3, 3, 3], offset: -20, degrees: 30, wait: 0},
		{type: "enemy-night", radius: [2,3,4,5,4,3,2], speed: [135,140,145,150,155,160,165], amount: [3, 3, 3, 3, 3, 3, 3], offset: 20, degrees: 30, wait: 0.2},
		{type: "enemy-night", radius: [2,3,4,5,4,3,2], speed: [135,140,145,150,155,160,165], amount: [3, 3, 3, 3, 3, 3, 3], offset: 0, degrees: 30, wait: 1.8},
	],
	[
		{type: "enemy-night", radius: [16,14,14,12,12,10,10], speed: 120, amount: [4, 4, 4, 4, 4, 4, 4], offset: [45, 40, 50, 35, 55, 30, 60], degrees: 270, angle: 90, wait: 1.5},
		{type: "enemy-night", radius: [16,14,14,12,12,10,10], speed: 120, amount: [4, 4, 4, 4, 4, 4, 4], offset: [45, 40, 50, 35, 55, 30, 60], degrees: 270, angle: 45, wait: 1.5},
	]
];
